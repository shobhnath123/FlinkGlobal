...
window.onload = function () {
    ...
    if (currentUrl.includes("/downloads")) {
        document.getElementById("myAccountTabName").innerText = "- Downloads";
    } else if (currentUrl.includes("/orders")) {
        document.getElementById("myAccountTabName").innerText = "- Orders";
    } else if (currentUrl.includes("/edit-address")) {
        document.getElementById("myAccountTabName").innerText = "- Address";
    } else if (currentUrl.includes("/edit-account")) {
        document.getElementById("myAccountTabName").innerText =
            "- Account details";
    } else {
        document.getElementById("myAccountTabName").innerText = "";
    }
