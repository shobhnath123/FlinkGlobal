                    ...
                    <div class="container">
                        ...
                        <table class="header-table">
                            <tr>
                                <td width="60%">
                                    <div class="main-logo">
                                        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('FG-Combine.png'))) }}"
                                         width="200px" alt="flinktech">
                                        {{-- <div style="font-size: 9px; margin-top: 8px;">Application No.: FG-00111{{$app->id }}</div> --}}
                                        ...
                                        <table style="width: 100%; border-collapse: collapse;border:none;">
                                            <tr>
                                                <td
                                                    ...
                                                    <!--<img src="{{ asset('ec.webp') }}" style="height: 20px; display: block;" alt="EC">-->
                                                </td>
