                    ...
                    <div class="p-3 sm:p-4 border-b border-grey-light">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                                ...
                                <button type="submit" id="bulk-delete-btn" class="bg-red-500 text-white font-bold px-3 py-2 sm:px-4 rounded focus:outline-none shadow hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm" disabled>
                                    Delete Selected
                                </button>
                            </div>
                            @endcanany
