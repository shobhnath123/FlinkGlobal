...
<div class="container">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="{{ route('admin.business-credit-applications.index') }}" class="btn btn-secondary mb-2">
                <i class="fas fa-arrow-left"></i> Back to List
            </a>
            <div class="card border-info text-start">
                <div class="card-body p-2">
                    <h6 class="card-title text-info mb-2"><i class="fas fa-user-cog"></i> Client Access</h6>
                    <form action="{{ route('admin.business-credit-applications.toggle-client-access', $application->id) }}" method="POST">
                        @csrf
                        <div class="form-check form-switch mb-1">
                            <input class="form-check-input" type="checkbox" id="client_can_view" name="client_can_view" value="1" {{ $application->client_can_view ? 'checked' : '' }}>
                            <label class="form-check-label" for="client_can_view"><small>Allow Client to View</small></label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="client_can_edit" name="client_can_edit" value="1" {{ $application->client_can_edit ? 'checked' : '' }}>
                            <label class="form-check-label" for="client_can_edit"><small>Allow Client to Edit</small></label>
                        </div>
                        <button type="submit" class="btn btn-sm btn-outline-info w-100">Update Access</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            ...
            @canany(['BusinessApp delete', 'BusinessApp own-delete'])
