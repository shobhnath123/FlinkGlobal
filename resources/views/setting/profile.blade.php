            ...
            <div class="container mx-auto px-6 py-8">
                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                        ...
                        <h4 class="text-gray-600 font-medium mb-4">Change Password <span class="text-sm font-normal text-gray-500">(Leave blank if you don't want to change)</span></h4>

                        <div class="flex flex-col space-y-2 mt-4">
                            <label for="password" class="text-gray-700 select-none font-medium">New Password</label>
                        ...
                        <div class="flex flex-col space-y-2 mt-4">
                            <label for="password_confirmation" class="text-gray-700 select-none font-medium">Confirm New Password</label>
