...
<body>
    ...
    <div class="content">
        ...
        <div class="section">
            <h2>20. Trusts</h2>
            <p class="clause"><span class="num">20.1</span>If the Client at any time upon or subsequent to entering into the Contract is acting in the capacity of trustee of any trust or as an agent for a trust ("Trust") then whether or not the Supplier may have notice of the Trust, the Client covenants with the Supplier as follows:</p>
            <ol class="sub-list">
